...
namespace RNMGP {
	...
	root_layout->addLayout(message_layout);
        ...
        output_reset_button_ = new QPushButton("机器人复位");
        manipulate_layout->addWidget(output_reset_button_);
        output_cancel_button_ = new QPushButton("取消导航");
        manipulate_layout->addWidget(output_cancel_button_);
        output_startNavi_button_ = new QPushButton("导航开始！");
...
PLUGINLIB_EXPORT_CLASS(RNMGP::MultiNaviGoalsPanel, rviz::Panel)
